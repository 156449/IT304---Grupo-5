...
<img src="https://i.upmath.me/svg/x_%7B1%2C2%7D%20%3D%20%7B-b%5Cpm%5Csqrt%7Bb%5E2%20-%204ac%7D%20%5Cover%202a%7D." alt=" F_{drp} = \left [  \max_{i=1}^n \left ( D_{at} \times \frac{0,92}{F_{pp}} \right ) - D_{fp}  \right ] \times T_{dap}  ; F_{erp} = \sum_{i=1}^{n}\left [  C_{at} \times \left (  \frac{0,92}{F_{pp}} -1 \right )   \right ] \times T_{eap}" />
